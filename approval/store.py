...
def _batch_from_payload(payload: dict[str, Any]) -> ApprovalBatch:
    ...
    return ApprovalBatch(
        ...
        broker_connectivity_profile_path=payload.get("broker_connectivity_profile_path"),
        broker_connectivity_report_path=payload.get("broker_connectivity_report_path"),
        broker_readonly_mirror_report_path=payload.get("broker_readonly_mirror_report_path"),
        ...
        broker_connectivity_summary=dict(payload.get("broker_connectivity_summary") or {}),
        broker_readonly_summary=dict(payload.get("broker_readonly_summary") or {}),
...
def _replace_batch_status(batch: ApprovalBatch, status: str, decision: ApprovalDecision) -> ApprovalBatch:
    return ApprovalBatch(
        ...
        broker_connectivity_profile_path=batch.broker_connectivity_profile_path,
        broker_connectivity_report_path=batch.broker_connectivity_report_path,
        broker_readonly_mirror_report_path=batch.broker_readonly_mirror_report_path,
        ...
        broker_connectivity_summary=batch.broker_connectivity_summary,
        broker_readonly_summary=batch.broker_readonly_summary,
