...
from auto_alpha.research.discovery.suite.run_suite import main as run_suite_main
...
def test_research_suite_formula_corpus_pretrain_batch_eval(tmp_path, capsys):
    ...
    assert (tmp_path / "suite" / "formula_corpus" / "auto_alpha.research.formulas.corpus.jsonl").exists()
