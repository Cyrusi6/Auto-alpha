...
from auto_alpha.research.discovery.benchmark import run_benchmark
from auto_alpha.research.discovery.benchmark.run_benchmark import main as benchmark_main
