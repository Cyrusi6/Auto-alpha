...
def test_alpha_factory_compute_scheduler_runs_real_batch_eval_jobs(tmp_path, capsys, monkeypatch):
    ...
    monkeypatch.setattr("auto_alpha.research.discovery.factory.runner.run_proxy_eval", fixed_proxy_shortlist)
    monkeypatch.setattr("auto_alpha.research.discovery.factory.runner.run_full_research", fixed_full_research)
