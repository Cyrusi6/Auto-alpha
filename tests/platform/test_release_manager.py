...
from auto_alpha.platform.governance.release.inventory import (
    build_cli_inventory,
    build_dependency_inventory,
    build_module_inventory,
)
from auto_alpha.platform.governance.release.run_release import main as release_main
...
def test_release_inventories_cover_platform_modules():
    ...
    assert "auto_alpha.research.formulas.runtime.engine" in cli_modules
