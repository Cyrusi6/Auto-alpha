...
from artifact_schema.writer import attach_artifact_metadata, write_json_artifact, write_jsonl_artifact
from artifact_schema.validator import validate_artifact
from alpha_factory.models import AlphaCampaignConfig
from alpha_factory.runner import AlphaFactoryRunner
...
from monitoring.checks import check_sealed_holdout_validation
from validation_red_team.candidate_pool import freeze_candidate_pool, validate_candidate_pool_manifest
from validation_red_team.capability import HoldoutCapabilityRegistry
from validation_red_team.contracts import HoldoutCalibrationProfile, SealedHoldoutPolicy, publish_holdout_policy
from validation_red_team.evaluator import ValidationRedTeamAgent
from validation_red_team.io import HoldoutContractError, atomic_json, sha256_file, stable_hash
from validation_red_team.preflight import preflight_canonical_holdout
from validation_red_team.verifier import verify_holdout_result
from validation_red_team.view import VIEW_CORE_FIELDS
...
def test_contaminated_canonical_freeze_preflight_stays_blocked(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "validation_red_team.preflight.validate_canonical_research_freeze",
        lambda path: {
            "content_hash": "a" * 64,
            "sealed_holdout": {
