...
from alpha_factory.full_research import run_full_research
from alpha_factory.models import AlphaCandidateRecord
from alpha_factory.proxy_eval import run_proxy_eval
from alpha_factory.research_policy import load_alpha_research_policy
from alpha_factory.scoring import score_candidates
from alpha_factory.trial_ledger import write_trial_ledger
from evaluation import ObjectiveSpec, normalize_objective_rows
from factor_store import has_positive_oos_evidence
from model_core.backtest import AShareFactorEvaluator
from monitoring.checks import check_alpha_factory_campaign
...
def test_full_research_uses_lookback_plus_horizon_and_proper_trial_correction(monkeypatch):
    monkeypatch.setattr("alpha_factory.full_research.StackVM", _IdentityVM)
    loader = _ResearchLoader()
