...
from auto_alpha.platform.artifacts.schema.run_validate import main as schema_main
...
def test_data_quality_scan_api_and_dashboard_loaders(tmp_path: Path) -> None:
    ...
    from auto_alpha.data.quality.lab.report import write_data_quality_lab_report
