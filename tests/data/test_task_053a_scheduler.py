...
from auto_alpha.validation.lab.campaigns.replay_evidence import compare_replay_evidence, publish_replay_bundle, validate_terminal_outputs
from auto_alpha.validation.lab.campaigns.scheduler import _load_task052a_readiness, run_validation_shards
...
def test_task053a_four_by_five_strict_artifacts_and_resume(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("auto_alpha.validation.lab.campaigns.scheduler.probe_compute_resources", _snapshot)
    ...
    monkeypatch.setattr("auto_alpha.validation.lab.campaigns.scheduler.LocalComputeScheduler", Scheduler)
    ...
    monkeypatch.setattr("auto_alpha.validation.lab.campaigns.scheduler.LocalComputeScheduler", ForbiddenScheduler)
