...
from auto_alpha.portfolio.construction.campaigns import main as portfolio_campaign_main
from auto_alpha.validation.walk_forward.campaigns_run_validation_store import main as validation_campaign_main
