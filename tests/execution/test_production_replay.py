...
from auto_alpha.execution.operations.replay.models import ProductionReplayConfig, ReplayMode
from auto_alpha.execution.operations.replay.run_replay import main as replay_main
from auto_alpha.execution.operations.replay.runner import ProductionReplayRunner
...
def test_production_replay_runner_auto_approves_and_resumes(monkeypatch, tmp_path: Path):
    ...
    monkeypatch.setattr("auto_alpha.execution.operations.replay.runner.production_main", fake_production_main)
    monkeypatch.setattr("auto_alpha.execution.operations.replay.runner.approval_main", fake_approval_main)
