...
TARGETS = [
    ...
    Path("src/auto_alpha/execution/trading/paper/__init__.py"),
    Path("src/auto_alpha/execution/trading/paper/models.py"),
    Path("src/auto_alpha/execution/trading/paper/ledger.py"),
    Path("src/auto_alpha/execution/trading/paper/performance.py"),
    Path("src/auto_alpha/execution/trading/paper/run_account.py"),
    Path("src/auto_alpha/execution/operations/daily/__init__.py"),
    Path("src/auto_alpha/execution/operations/daily/models.py"),
    Path("src/auto_alpha/execution/operations/daily/daily_runner.py"),
    Path("src/auto_alpha/execution/operations/daily/report.py"),
    Path("src/auto_alpha/execution/operations/daily/run_daily.py"),
    ...
    Path("src/auto_alpha/execution/trading/engine/paper_broker.py"),
