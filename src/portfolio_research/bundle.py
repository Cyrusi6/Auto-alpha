"""Content-addressed inputs for certified-factor portfolio research."""
...
def publish_portfolio_research_bundle(
    ...
    *,
    ...
    try:
        ...
        _write_json(staging / "corporate_actions.json", list(data.corporate_actions))
        _register(artifacts, staging, "corporate_actions", staging / "corporate_actions.json")
