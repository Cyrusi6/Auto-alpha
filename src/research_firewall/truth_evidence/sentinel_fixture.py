...
COMPONENT_FILES = {
    "loader": "src/model_core/data_loader.py",
    "stackvm_validity": "src/model_core/vm.py",
    "alpha_proxy": "src/alpha_factory/proxy_eval.py",
    "formula_batch_evaluator": "src/formula_batch_eval/evaluator.py",
    "factor_materializer": "src/validation_lab/materialization.py",
    "validation_lab": "src/validation_lab/run_validation.py",
    "consolidation_cache": "src/validation_campaign_store/run_validation_store.py",
}
