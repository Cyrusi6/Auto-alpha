...
ALLOWED_COMPONENTS: dict[str,str] = {
 ...
 'v3_tensor_builder':'feature_factory.engineering_replay.orchestrator.build_v3_tensor_generation',
 'strict_matrix_validator':'research_firewall.engineering_closure.validators.validate_strict_matrix_generation',
 'v3_tensor_validator':'research_firewall.engineering_closure.validators.validate_v3_tensor_generation',
 'research_projection_publisher':'research_firewall.engineering_closure.research_view.publish_research_projection',
