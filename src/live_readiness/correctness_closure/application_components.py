...
from live_readiness.production_authority.application import (
    _matrix_marks,
    _publish_dynamic_l2,
...
def production_stage_definitions() -> tuple[StageDefinition, ...]:
    ...
    return tuple(
        StageDefinition(
            ...
            validator_fqn=f"live_readiness.correctness_closure.application_components.{validators[name].__name__}",
        )
