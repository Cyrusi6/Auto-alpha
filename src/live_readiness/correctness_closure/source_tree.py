...
from live_readiness.network_authorization.io import canonical_hash, validate_generation
...
def git_index_source_entries(repository: Path, *, treeish: str | None = None) -> list[dict[str, Any]]:
    ...
    required = {
        "src/live_readiness/correctness_closure/contracts.py",
        "src/live_readiness/correctness_closure/source_tree.py",
        "src/live_readiness/correctness_closure/broker.py",
        "src/live_readiness/correctness_closure/gateway.py",
        "src/live_readiness/correctness_closure/immutable.py",
        "src/live_readiness/correctness_closure/stage_machine.py",
        "src/live_readiness/correctness_closure/lease.py",
        "src/live_readiness/correctness_closure/release.py",
        "src/live_readiness/correctness_closure/application.py",
        "src/live_readiness/correctness_closure/application_cli.py",
        "src/live_readiness/correctness_closure/application_components.py",
        "src/live_readiness/correctness_closure/independent.py",
        "src/live_readiness/correctness_closure/rehearsal.py",
        "src/live_readiness/correctness_closure/network_cli.py",
        "src/live_readiness/correctness_closure/verifier.py",
