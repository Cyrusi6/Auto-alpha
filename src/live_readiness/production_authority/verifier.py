...
def verify_scrubbed_evidence(
    ...
    required_sources = {
        "src/live_readiness/production_authority/executor.py",
        "src/live_readiness/production_authority/application.py",
        "src/live_readiness/production_authority/authority.py",
        "src/live_readiness/production_authority/verifier.py",
        "src/data_pipeline/ashare/providers/tushare_client.py",
        "src/validation_lab/materialization.py",
        "src/model_core/vm.py",
