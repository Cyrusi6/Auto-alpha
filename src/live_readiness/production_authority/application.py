...
from live_readiness.holdout_simulation.bundle import EXECUTION_MASKS, SIGNAL_MASKS, load_simulation_bundle, validate_simulation_bundle
from live_readiness.holdout_simulation.run import prepare_simulation_inputs
from live_readiness.evidence_hardening.causal import build_valuation_surface, trace_causal_runs
from live_readiness.evidence_hardening.valuation import load_valuation_projection, publish_valuation_projection
from live_readiness.production_hardening.truth import publish_truth_successor, validate_truth_v2
from live_readiness.network_authorization.fee import FeeProjectionCalculator
from live_readiness.network_authorization.independent import independently_trace_prepared
from live_readiness.network_authorization.io import atomic_json, canonical_hash, publish_generation, read_json, sha256_file, validate_generation
from validation_lab.materialization import FactorMaterializer

from live_readiness.canary_authority.application import (
...
def _independent_successor_prepared(successor_bundle: Mapping[str, Any], projection: Mapping[str, Any]) -> dict[str, Any]:
    from live_readiness.network_authorization.independent import _prepare
