...
from live_readiness.network_authorization.io import canonical_hash, publish_generation, read_json, sha256_file, validate_generation
...
def _old_entrypoint_case() -> dict[str, Any]:
    ...
    from live_readiness.native_replay.cascade import CascadeError, execute_transport_stage
    from live_readiness.secure_acquisition.network import NetworkGateError, execute_plan
    from live_readiness.evidence_hardening.network import Task055FNetworkError, execute_canary
    from live_readiness.production_hardening.network_state import Task055GNetworkStateError, execute_l1_canary, execute_l1_resume, execute_l2_canary, execute_l2_resume
    from live_readiness.network_authorization.network import Task055HNetworkError, ordered_future_canary_gate
    from live_readiness.canary_authority.executor import Task055IExecutionError, execute_single_canary
