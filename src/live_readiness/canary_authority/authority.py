...
from live_readiness.network_authorization.authorization import validate_authorization_seal, verify_scrubbed_evidence_package
...
from live_readiness.network_authorization.run import verify_task055h_report
...
def publish_task055i_authority(
    *,
    ...
    runtime_semantic = {
        ...
        "production_cli": "python -m live_readiness.canary_authority.network_cli canary",
