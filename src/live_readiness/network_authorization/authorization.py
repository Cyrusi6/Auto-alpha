...
from live_readiness.production_hardening.network_state import PLAN_SCHEMA, consolidate, verify_state_read_only
from live_readiness.production_hardening.run import verify_task055g_final_report
    ...
    *,
    ...
    try:
        ...
        journal.record_validator_exception(
            ...
            validator_fqn="live_readiness.production_hardening.run.verify_task055g_final_report",
    ...
    try:
        ...
        journal.record_validator_exception(
            ...
            validator_fqn="live_readiness.network_authorization.fee.attest_fee_schedule",
    ...
    try:
        ...
        journal.record_validator_exception(
            ...
            validator_fqn="live_readiness.network_authorization.operational.publish_operational_seal",
    ...
    if fee is not None:
        try:
            ...
            journal.record_validator_exception(
                ...
                validator_fqn="live_readiness.network_authorization.independent.independently_replay_causal_frontier",
...
def _semantic_source_hashes(repository: Path) -> dict[str, str]:
    relatives = (
        "src/live_readiness/holdout_simulation/bundle.py",
        "src/live_readiness/holdout_simulation/policy.py",
        "src/live_readiness/holdout_simulation/run.py",
        "src/live_readiness/holdout_simulation/simulator.py",
        "src/live_readiness/evidence_hardening/causal.py",
        "src/live_readiness/evidence_hardening/valuation.py",
        "src/live_readiness/production_hardening/access.py",
        "src/live_readiness/production_hardening/bundle.py",
        "src/live_readiness/production_hardening/causal.py",
        "src/live_readiness/production_hardening/fees.py",
        "src/live_readiness/production_hardening/lineage.py",
        "src/live_readiness/production_hardening/network_state.py",
        "src/live_readiness/production_hardening/operational.py",
        "src/live_readiness/production_hardening/run.py",
        "src/live_readiness/production_hardening/truth.py",
        "src/live_readiness/production_hardening/verifier.py",
        ...
        "src/live_readiness/network_authorization/journal.py",
