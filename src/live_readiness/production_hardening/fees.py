...
def semantic_source_hashes() -> dict[str, str]:
    import live_readiness.holdout_simulation.policy as policy_module
    import live_readiness.holdout_simulation.simulator as simulator_module
    import live_readiness.holdout_simulation.verifier as verifier_module

    return {
        "live_readiness.holdout_simulation.policy": _module_source_hash(policy_module),
        "live_readiness.holdout_simulation.simulator": _module_source_hash(simulator_module),
        "live_readiness.holdout_simulation.verifier": _module_source_hash(verifier_module),
        "live_readiness.production_hardening.fees": _source_hash(Path(__file__)),
    }
