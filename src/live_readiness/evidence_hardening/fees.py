    ...
    *,
    ...
    try:
        for spec in specs:
            ...
            receipt = {
                "producer": "live_readiness.evidence_hardening.fees.acquire_official_fee_documents",
...
def _validate_retrieval_receipt(
    ...
    *,
    ...
    if receipt.get("producer") != "live_readiness.evidence_hardening.fees.acquire_official_fee_documents":
