...
def recompute_run_truth(
    ...
    *,
    ...
    if valuation_projection_manifest is not None or projection_reference.is_file():
        from live_readiness.evidence_hardening.valuation import load_valuation_projection
        ...
        from live_readiness.valuation_remediation.verifier import build_mark_matrices
