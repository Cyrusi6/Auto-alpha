...
def publish_simulation_run(
    *,
    ...
    if valuation_projection_manifest is not None:
        from live_readiness.evidence_hardening.valuation import validate_valuation_projection
        ...
        from live_readiness.valuation_remediation.verifier import make_official_mark_rows
    ...
    if fee_schedule_manifest is not None:
        ...
        if candidate is not None:
            try:
                from live_readiness.evidence_hardening.fees import validate_fee_schedule_v2
