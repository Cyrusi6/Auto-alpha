...
from auto_alpha.portfolio.simulation.capacity import write_capacity_report
...
from auto_alpha.validation.lab.engine.report import write_stress_backtest_artifacts
from auto_alpha.validation.lab.engine.stress_backtest import run_stress_backtest_bundle
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.run_leakage_audit:
        from auto_alpha.validation.firewall.leakage.run_audit import main as leakage_audit_main
