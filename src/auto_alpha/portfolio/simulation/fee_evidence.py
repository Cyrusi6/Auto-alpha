"""Evidence-backed Fee Schedule v2 document workflow."""
...
from .evidence_contracts import FEE_DOCUMENT_ACQUISITION_SCHEMA, FEE_SCHEDULE_SCHEMA
from auto_alpha.platform.network_authority.access_journal import canonical_hash, sha256_file
    ...
    *,
    ...
    try:
        for spec in specs:
            ...
            receipt = {
                "producer": "auto_alpha.portfolio.simulation.fee_evidence.acquire_official_fee_documents",
...
def _validate_retrieval_receipt(
    ...
    *,
    ...
    if receipt.get("producer") != "auto_alpha.portfolio.simulation.fee_evidence.acquire_official_fee_documents":
