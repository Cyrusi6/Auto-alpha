...
from auto_alpha.portfolio.simulation.ledger_artifacts import BLOCKED_RUN_ARTIFACT_SCHEMA
from auto_alpha.portfolio.simulation.ledger_artifacts import MONEY_TOLERANCE_CNY
from auto_alpha.portfolio.simulation.ledger_artifacts import RUN_ARTIFACT_SCHEMA
from auto_alpha.portfolio.simulation.ledger_artifacts import RUN_POINTER_SCHEMA
...
def recompute_run_truth(
    ...
    *,
    ...
    if valuation_projection_manifest is not None or projection_reference.is_file():
        from auto_alpha.portfolio.simulation.valuation import load_valuation_projection
        ...
        from auto_alpha.portfolio.simulation.mark_verifier import build_mark_matrices
...
def verify_task055a_orchestration(output_root: str | Path) -> dict[str, Any]:
    ...
    from auto_alpha.portfolio.simulation.ledger_run import BLOCKED_STATUS
    from auto_alpha.portfolio.simulation.ledger_run import SUCCESS_STATUS
    from auto_alpha.portfolio.simulation.ledger_run import inspect_physical_states
