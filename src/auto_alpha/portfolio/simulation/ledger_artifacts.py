...
def publish_simulation_run(
    *,
    ...
    if valuation_projection_manifest is not None:
        from auto_alpha.portfolio.simulation.valuation import validate_valuation_projection
    ...
    try:
        ...
        from auto_alpha.portfolio.simulation.ledger_verifier import recompute_run_truth
