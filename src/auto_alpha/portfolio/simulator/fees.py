"""Governed Fee Schedule v2 production workflow.
...
def semantic_source_hashes() -> dict[str, str]:
    import auto_alpha.portfolio.simulator.ledger_policy as policy_module
    import auto_alpha.portfolio.simulator.ledger_simulator as simulator_module
    import auto_alpha.portfolio.simulator.ledger_verifier as verifier_module

    return {
        "auto_alpha.portfolio.simulator.ledger_policy": _module_source_hash(policy_module),
        "auto_alpha.portfolio.simulator.ledger_simulator": _module_source_hash(simulator_module),
        "auto_alpha.portfolio.simulator.ledger_verifier": _module_source_hash(verifier_module),
        "auto_alpha.portfolio.simulator.fees": _source_hash(Path(__file__)),
    }
