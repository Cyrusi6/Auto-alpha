"""Fee-aware held-position tracing and exact frontier sealing."""
...
from auto_alpha.portfolio.simulator.ledger_run import SCENARIO_NAMES
from auto_alpha.portfolio.simulator.ledger_run import prepare_simulation_inputs
...
from auto_alpha.platform.governance.network.transport import evidence_use_identity, transport_identity
from auto_alpha.platform.governance.network.access_journal import AuditedReader, canonical_hash, sha256_file
    ...
    try:
        ...
        write_artifact_sidecar(
            run_path,
            {
                ...
                "schema_version": "1.0",
                "producer": "auto_alpha.portfolio.simulator.causal",
