"""Immutable, content-addressed artifacts for event-ledger runs."""
...
def publish_simulation_run(
    *,
    ...
    if valuation_projection_manifest is not None:
        from auto_alpha.portfolio.simulator.valuation import validate_valuation_projection
    ...
    try:
        ...
        from auto_alpha.portfolio.simulator.ledger_verifier import recompute_run_truth
