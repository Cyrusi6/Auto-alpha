"""Project validated fee schedules onto simulator fills."""
...
from auto_alpha.portfolio.simulator.fees import independent_verify_fee_schedule, validate_fee_schedule_v2
