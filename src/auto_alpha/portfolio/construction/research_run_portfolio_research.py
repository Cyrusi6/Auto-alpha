"""Production CLI for certified-factor portfolio auto_alpha.research.discovery.studies."""
...
from auto_alpha.portfolio.simulation.fees import FeeScheduleCalculator

from auto_alpha.portfolio.construction.research_bundle import load_portfolio_research_bundle
from auto_alpha.portfolio.construction.research_contracts import DATA_BLOCKED_STATUS
...
from auto_alpha.portfolio.construction.research_report import publish_portfolio_research_result


def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run locked factor-certified portfolio walk-forward auto_alpha.research.discovery.studies.")
