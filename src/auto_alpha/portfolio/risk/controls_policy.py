...
from auto_alpha.portfolio.risk.controls_models import RiskControlPolicyManifest
...
def default_policy(profile: str = DEFAULT_PROFILE) -> RiskControlPolicy:
    ...
    return RiskControlPolicy(
        ...
        limits,
        restricted_symbols=[],
        notes="Default paper trading limits for local A-share research auto_alpha.execution.operations.daily.",
    )
