...
def build_rule_registry() -> list[DataQualityRuleDefinition]:
    rules = [
        ...
        _rule("auto_alpha.data.pit.corporate_actions.date_fields", "corporate_actions", "Valid corporate-action dates", "warning", "Corporate-action date fields should be valid.", "require_pit_review"),
        _rule("auto_alpha.data.pit.corporate_actions.non_negative", "corporate_actions", "Non-negative action values", "warning", "Dividend/share distribution values should be non-negative.", "rerun_dataset"),
