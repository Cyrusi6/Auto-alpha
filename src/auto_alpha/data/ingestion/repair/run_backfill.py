"""CLI for governed A-share backfill planning and auto_alpha.execution.trading.engine."""
...
from .backfill_chunking import dataset_chunk_days_for_strategy, parse_dataset_chunk_days
...
from .backfill_models import BackfillPlan
