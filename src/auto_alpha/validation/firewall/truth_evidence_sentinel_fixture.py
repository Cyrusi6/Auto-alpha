...
from auto_alpha.research.discovery.factory_proxy_eval import _rank_ic
...
from auto_alpha.validation.firewall.core_sentinel import TASK054_ACCESS_LEDGER
from auto_alpha.validation.firewall.core_sentinel import TASK054_PATH_RESULT


COMPONENT_MODULES = {
    "loader": "auto_alpha.research.formulas.runtime_data_loader",
    "stackvm_validity": "auto_alpha.research.formulas.runtime_vm",
    "alpha_proxy": "auto_alpha.research.discovery.factory_proxy_eval",
    "formula_batch_evaluator": "auto_alpha.research.formulas.batch_evaluator",
    "factor_materializer": "auto_alpha.validation.lab.engine_materialization",
    "validation_lab": "auto_alpha.validation.lab.engine_run_validation",
    "consolidation_cache": "auto_alpha.validation.lab.campaigns_run_validation_store",
}
