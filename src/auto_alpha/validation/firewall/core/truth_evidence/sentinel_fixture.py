...
from auto_alpha.research.discovery.factory.proxy_eval import _rank_ic
...
from auto_alpha.research.formulas.runtime.vocab import FormulaVocab
...
from auto_alpha.validation.firewall.core.sentinel import TASK054_ACCESS_LEDGER, TASK054_PATH_RESULT


COMPONENT_MODULES = {
    "loader": "auto_alpha.research.formulas.runtime.data_loader",
    "stackvm_validity": "auto_alpha.research.formulas.runtime.vm",
    "alpha_proxy": "auto_alpha.research.discovery.factory.proxy_eval",
    "formula_batch_evaluator": "auto_alpha.research.formulas.batch.evaluator",
    "factor_materializer": "auto_alpha.validation.lab.engine.materialization",
    "validation_lab": "auto_alpha.validation.lab.engine.run_validation",
    "consolidation_cache": "auto_alpha.validation.lab.campaigns.run_validation_store",
}
...
def _run_worker(args) -> None:
    ...
    result = {
        ...
        **hashes,
        "component_evidence": [
            {"component": name, "invoked": True, "source_hash": _sha256_file(module_file(module))}
            for name, module in sorted(COMPONENT_MODULES.items())
        ],
