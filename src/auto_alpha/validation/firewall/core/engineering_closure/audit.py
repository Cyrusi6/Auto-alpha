...
ALLOWED_COMPONENTS: dict[str,str] = {
 ...
 'v3_tensor_builder':'auto_alpha.research.features.factory.engineering_replay.orchestrator.build_v3_tensor_generation',
 'strict_matrix_validator':'auto_alpha.validation.firewall.core.engineering_closure.validators.validate_strict_matrix_generation',
 'v3_tensor_validator':'auto_alpha.validation.firewall.core.engineering_closure.validators.validate_v3_tensor_generation',
 'research_projection_publisher':'auto_alpha.validation.firewall.core.engineering_closure.research_view.publish_research_projection',
 'ashare_data_loader':'auto_alpha.research.formulas.runtime.data_loader.AShareDataLoader.load_data',
 'stackvm':'auto_alpha.research.formulas.runtime.vm.StackVM.execute_with_validity',
 'proxy_evaluator':'auto_alpha.research.discovery.factory.proxy_eval.run_proxy_eval',
 'formula_batch_evaluator':'auto_alpha.research.formulas.batch.evaluator.FormulaBatchEvaluator.run',
 'factor_materializer':'auto_alpha.validation.lab.engine.materialization.FactorMaterializer.materialize',
 'validation_service':'auto_alpha.validation.lab.engine.run_validation.run_validation_service',
 'campaign_store':'auto_alpha.validation.lab.campaigns.registry.LocalValidationCampaignStore.record_shard_results',
 'consolidation':'auto_alpha.validation.lab.campaigns.consolidate.consolidate_validation_results',
}
