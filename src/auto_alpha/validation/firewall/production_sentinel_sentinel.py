...
from auto_alpha.validation.firewall.production_sentinel_audit import atomic_json
from auto_alpha.validation.firewall.production_sentinel_audit import sha256_file
...
def _run_local_worker(run: SentinelRunSpec, *, timeout: int) -> None:
    command = [sys.executable, "-m", "auto_alpha.validation.firewall.production_sentinel_sentinel", "worker", "--config", run.config_path]
