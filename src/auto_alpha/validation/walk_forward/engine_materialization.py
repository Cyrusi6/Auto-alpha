...
def _code_semantic_hash() -> str:
    paths = [
        Path(__file__),
        module_file("auto_alpha.research.formulas.vm"),
        module_file("auto_alpha.research.formulas.operators"),
        module_file("auto_alpha.research.formulas.semantics"),
        module_file("auto_alpha.research.factors.engine"),
        module_file("auto_alpha.validation.walk_forward.engine_policy"),
        module_file("auto_alpha.validation.walk_forward.engine_splits"),
    ]
