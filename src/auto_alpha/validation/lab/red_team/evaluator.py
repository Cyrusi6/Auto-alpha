...
from auto_alpha.validation.lab.engine.metrics import evaluate_factor_dates

from .candidate_pool import validate_candidate_pool_manifest
from .capability import HoldoutCapabilityRegistry
from .contracts import SealedHoldoutPolicy, validate_holdout_policy
from .io import HoldoutContractError, atomic_json, atomic_jsonl, read_json, sha256_file, stable_hash
from .view import resolve_view_artifact, validate_sealed_holdout_view
...
def validate_sealed_holdout_view(path: str | Path, *, open_payloads: bool = False) -> dict[str, Any]:
    from .view import validate_sealed_holdout_view as validate
