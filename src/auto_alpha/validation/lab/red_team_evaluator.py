...
from auto_alpha.validation.lab.red_team_contracts import validate_holdout_policy
...
from auto_alpha.validation.lab.red_team_io import atomic_jsonl
...
from auto_alpha.validation.lab.red_team_view import resolve_view_artifact
from auto_alpha.validation.lab.red_team_view import validate_sealed_holdout_view
...
def validate_sealed_holdout_view(path: str | Path, *, open_payloads: bool = False) -> dict[str, Any]:
    from auto_alpha.validation.lab.red_team_view import validate_sealed_holdout_view as validate
