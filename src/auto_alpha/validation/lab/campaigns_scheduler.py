...
from auto_alpha.validation.lab.campaigns_models import ValidationShardRecord
from auto_alpha.validation.lab.campaigns_registry import LocalValidationCampaignStore
from auto_alpha.validation.lab.campaigns_replay_evidence import build_input_manifest
...
from auto_alpha.validation.lab.campaigns_replay_evidence import read_candidate_ids
...
from auto_alpha.validation.lab.campaigns_replay_evidence import write_terminal_evidence
        ...
        for shard in shards:
            ...
            jobs.append(
                ComputeJobSpec(
                    ...
                    command=[sys.executable, "-m", "auto_alpha.validation.lab.engine_run_validation", *argv],
                    cwd=str(Path.cwd()),
...
def _run_task052a_replay(
    ...
    *,
    ...
    code_paths = {
        ...
        "worker_code": module_file("auto_alpha.validation.lab.campaigns_replay_worker"),
        "evidence_code": module_file("auto_alpha.validation.lab.campaigns_replay_evidence"),
        "validation_code": module_file("auto_alpha.validation.lab.engine_run_validation"),
        "materializer_code": module_file("auto_alpha.validation.lab.engine_materialization"),
        "stackvm_code": module_file("auto_alpha.research.formulas.runtime_vm"),
        "operator_code": module_file("auto_alpha.research.formulas.runtime_ops"),
        "operator_validity_code": module_file("auto_alpha.research.formulas.runtime_validity"),
        "transform_code": module_file("auto_alpha.research.factors.engine_transforms"),
        "feature_validity_code": module_file("auto_alpha.research.features.factory_validity"),
        "vocab_adapter_code": module_file("auto_alpha.research.features.factory_vocab_adapter"),
    }
...
def _job_fingerprint(argv: list[str], shard: ValidationShardRecord) -> str:
    ...
    code_files = [
        Path(__file__),
        module_file("auto_alpha.validation.lab.engine_run_validation"),
        module_file("auto_alpha.validation.lab.engine_materialization"),
        module_file("auto_alpha.validation.lab.engine_metrics"),
    ]
    payload = json.dumps({
        "argv": argv,
