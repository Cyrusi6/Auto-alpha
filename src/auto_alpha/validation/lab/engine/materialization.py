...
from auto_alpha.research.factors.engine.transforms import preprocess_factor_with_validity
...
from auto_alpha.research.features.factory.builder import load_feature_manifest
...
from auto_alpha.data.lake.store.task052_freeze import resolve_task052_governed_freeze_manifest
...
def _code_semantic_hash() -> str:
    paths = [
        Path(__file__),
        module_file("auto_alpha.research.formulas.runtime.vm"),
        module_file("auto_alpha.research.formulas.runtime.ops"),
        module_file("auto_alpha.research.formulas.runtime.validity"),
        module_file("auto_alpha.research.factors.engine.transforms"),
        module_file("auto_alpha.validation.lab.engine.policy"),
        module_file("auto_alpha.validation.lab.engine.splits"),
    ]
    return _hash_json({path.as_posix(): _sha256(path) for path in paths})
