...
from auto_alpha.validation.lab.engine.run_validation import main as validation_lab_main
        ...
        for shard in shards:
            ...
            jobs.append(
                ComputeJobSpec(
                    ...
                    command=[sys.executable, "-m", "auto_alpha.validation.lab.engine.run_validation", *argv],
                    cwd=str(Path.cwd()),
...
def _run_task052a_replay(
    ...
    *,
    ...
    code_paths = {
        ...
        "validation_code": module_file("auto_alpha.validation.lab.engine.run_validation"),
        "materializer_code": module_file("auto_alpha.validation.lab.engine.materialization"),
        "stackvm_code": module_file("auto_alpha.research.formulas.runtime.vm"),
        "operator_code": module_file("auto_alpha.research.formulas.runtime.ops"),
        "operator_validity_code": module_file("auto_alpha.research.formulas.runtime.validity"),
        "transform_code": module_file("auto_alpha.research.factors.engine.transforms"),
        "feature_validity_code": module_file("auto_alpha.research.features.factory.validity"),
        "vocab_adapter_code": module_file("auto_alpha.research.features.factory.vocab_adapter"),
    }
        ...
        jobs.append(
            ComputeJobSpec(
                ...
                command=[
                    sys.executable,
                    "-m",
                    "auto_alpha.validation.lab.campaigns.replay_worker",
                    "--telemetry-path",
                    str(telemetry_path),
                    "--candidate-pool-path",
...
def _job_fingerprint(argv: list[str], shard: ValidationShardRecord) -> str:
    ...
    code_files = [
        Path(__file__),
        module_file("auto_alpha.validation.lab.engine.run_validation"),
        module_file("auto_alpha.validation.lab.engine.materialization"),
        module_file("auto_alpha.validation.lab.engine.metrics"),
    ]
    payload = json.dumps({
        "argv": argv,
