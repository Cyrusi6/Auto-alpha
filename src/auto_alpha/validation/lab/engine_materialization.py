...
from auto_alpha.research.factors.engine_transforms import preprocess_factor_with_validity
...
def _code_semantic_hash() -> str:
    paths = [
        Path(__file__),
        module_file("auto_alpha.research.formulas.runtime_vm"),
        module_file("auto_alpha.research.formulas.runtime_ops"),
        module_file("auto_alpha.research.formulas.runtime_validity"),
        module_file("auto_alpha.research.factors.engine_transforms"),
        module_file("auto_alpha.validation.lab.engine_policy"),
        module_file("auto_alpha.validation.lab.engine_splits"),
    ]
