...
from auto_alpha.validation.certification.campaigns_models import FactorCertificationCampaignRecord
from auto_alpha.validation.certification.campaigns_models import FactorCertificationItemRecord
