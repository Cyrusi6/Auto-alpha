...
from auto_alpha.execution.broker.file_gateway.inbox import import_inbox_files, synthesize_inbox_files
from auto_alpha.execution.broker.file_gateway.packager import export_file_batch
from auto_alpha.execution.broker.file_gateway.profiles import load_profile
from auto_alpha.execution.broker.file_gateway.report import write_gateway_report
from auto_alpha.execution.broker.file_gateway.roundtrip import run_file_roundtrip_check
from auto_alpha.execution.broker.mapping.certifier import load_mapping_decision
from auto_alpha.execution.broker.adapter import (
    BrokerAdapterConfig,
...
from auto_alpha.execution.trading.engine import ExecutionOrder, PaperBroker, export_fills_jsonl, export_orders_csv, export_orders_jsonl
from auto_alpha.execution.trading.plan import ChildOrder, ExecutionPlanResult, ExecutionSchedule, ParentOrder, simulate_child_orders, write_execution_plan_report
...
from auto_alpha.research.factors.registry import LocalModelRegistry, ModelKind, ModelLifecycleStatus, write_model_registry_report
from auto_alpha.execution.trading.paper import LocalPaperAccount, compute_account_performance
from auto_alpha.execution.operations.handoff.checklist import required_item_ids
from auto_alpha.execution.operations.handoff.report import write_operator_handoff_report
from auto_alpha.execution.operations.handoff.store import LocalOperatorHandoffStore, create_package
...
from auto_alpha.execution.trading.strategy.runner import AShareStrategyRunner
...
class ProductionDailyRunner:
    ...
    def _run_eod_reconciliation_workflow(self, trade_date: str, broker_batch_id: str | None = None) -> dict[str, Any]:
        from auto_alpha.execution.broker.statements import import_statement
