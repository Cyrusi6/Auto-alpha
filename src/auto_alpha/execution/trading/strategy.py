"""A-share strategy configuration, portfolio construction, and risk execution."""
...
from auto_alpha.portfolio.simulator.backtest import TargetPosition
...
from auto_alpha.platform.governance.approval import ApprovalBatch, ApprovalOrder, LocalApprovalStore
from auto_alpha.portfolio.simulator.backtest import TargetPosition, build_long_only_targets, describe_factor, factor_values_to_matrix, select_factor_id
from auto_alpha.portfolio.simulator.capacity import CapacityConfig, build_capacity_report, write_capacity_report
from auto_alpha.execution.trading.engine import PaperBroker, export_fills_jsonl, export_orders_csv, export_orders_jsonl
from auto_alpha.execution.trading.plan import (
    ExecutionPlanConfig,
    ExecutionPlanResult,
...
from auto_alpha.portfolio.construction.optimizer import (
    OptimizationConfig,
    PortfolioOptimizer,
...
from auto_alpha.portfolio.risk.controls import create_override_approval
