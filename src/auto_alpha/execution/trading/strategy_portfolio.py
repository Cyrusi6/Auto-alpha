"""A-share strategy target book; consolidated from auto_alpha.execution.trading.strategy."""

from __future__ import annotations

from dataclasses import dataclass

from auto_alpha.portfolio.simulation.backtest import TargetPosition
