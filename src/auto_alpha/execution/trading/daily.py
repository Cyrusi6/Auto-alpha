"""Daily execution operations models, reporting, orchestration, and command workflow."""
...
from auto_alpha.execution.broker.mapping import load_mapping_decision
...
from auto_alpha.execution.trading.handoff import write_operator_handoff_report
from auto_alpha.execution.trading.handoff import LocalOperatorHandoffStore
from auto_alpha.execution.trading.handoff import create_package
...
from auto_alpha.execution.trading.strategy import AShareStrategyRunner
...
class ProductionDailyRunner:
    ...
    def _run_eod_reconciliation_workflow(self, trade_date: str, broker_batch_id: str | None = None) -> dict[str, Any]:
        ...
        from auto_alpha.execution.settlement.reconciliation import apply_approved_adjustments
        from auto_alpha.execution.settlement.reconciliation import create_adjustment_approval
        ...
        if self.run_eod_reconciliation and statement_dir:
            ...
            if self.create_adjustment_approval:
                ...
                if batch_path and Path(batch_path).exists():
                    ...
                    from auto_alpha.execution.settlement.reconciliation import AdjustmentProposal
                    from auto_alpha.execution.settlement.reconciliation import AdjustmentProposalBatch
