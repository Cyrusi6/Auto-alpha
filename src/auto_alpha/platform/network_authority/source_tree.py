...
from auto_alpha.platform.network_authority._internal.authorization.io import canonical_hash, validate_generation
...
def git_index_source_entries(repository: Path, *, treeish: str | None = None) -> list[dict[str, Any]]:
    ...
    required = {
        "src/auto_alpha/platform/network_authority/contracts.py",
        "src/auto_alpha/platform/network_authority/source_tree.py",
        "src/auto_alpha/platform/network_authority/broker.py",
        "src/auto_alpha/platform/network_authority/gateway.py",
        "src/auto_alpha/platform/network_authority/immutable.py",
        "src/auto_alpha/platform/network_authority/stage_machine.py",
        "src/auto_alpha/platform/network_authority/lease.py",
        "src/auto_alpha/platform/network_authority/release.py",
        "src/auto_alpha/platform/network_authority/application.py",
        "src/auto_alpha/platform/network_authority/application_cli.py",
        "src/auto_alpha/platform/network_authority/application_components.py",
        "src/auto_alpha/platform/network_authority/independent.py",
        "src/auto_alpha/platform/network_authority/rehearsal.py",
        "src/auto_alpha/platform/network_authority/network_cli.py",
