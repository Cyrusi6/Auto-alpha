...
from auto_alpha.platform.network_authority._internal.validation.network_state import PLAN_SCHEMA, consolidate, verify_state_read_only
from auto_alpha.platform.network_authority._internal.validation.run import verify_task055g_final_report
    ...
    *,
    ...
    try:
        ...
        journal.record_validator_exception(
            ...
            validator_fqn="auto_alpha.platform.network_authority._internal.validation.run.verify_task055g_final_report",
    ...
    try:
        ...
        journal.record_validator_exception(
            ...
            validator_fqn="auto_alpha.platform.network_authority._internal.authorization.fee.attest_fee_schedule",
    ...
    try:
        ...
        journal.record_validator_exception(
            ...
            validator_fqn="auto_alpha.platform.network_authority._internal.authorization.operational.publish_operational_seal",
    ...
    if fee is not None:
        try:
            ...
            journal.record_validator_exception(
                ...
                validator_fqn="auto_alpha.platform.network_authority._internal.authorization.independent.independently_replay_causal_frontier",
...
def _semantic_source_hashes(repository: Path) -> dict[str, str]:
    relatives = (
        "src/auto_alpha/platform/network_authority/_internal/simulation/bundle.py",
        "src/auto_alpha/platform/network_authority/_internal/simulation/policy.py",
        "src/auto_alpha/platform/network_authority/_internal/simulation/run.py",
        "src/auto_alpha/platform/network_authority/_internal/simulation/simulator.py",
        "src/auto_alpha/platform/network_authority/_internal/evidence/causal.py",
        "src/auto_alpha/platform/network_authority/_internal/evidence/valuation.py",
        "src/auto_alpha/platform/network_authority/_internal/validation/access.py",
        "src/auto_alpha/platform/network_authority/_internal/validation/bundle.py",
        ...
        "src/auto_alpha/platform/network_authority/_internal/validation/lineage.py",
        "src/auto_alpha/platform/network_authority/_internal/validation/network_state.py",
        "src/auto_alpha/platform/network_authority/_internal/validation/operational.py",
        "src/auto_alpha/platform/network_authority/_internal/validation/run.py",
        "src/auto_alpha/platform/network_authority/_internal/validation/truth.py",
        "src/auto_alpha/platform/network_authority/_internal/validation/verifier.py",
        "src/auto_alpha/data/ingestion/pipeline/ashare/cache.py",
        ...
        "src/auto_alpha/platform/network_authority/_internal/authorization/journal.py",
