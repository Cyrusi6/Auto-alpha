...
from auto_alpha.platform.network_authority._internal.evidence.valuation import load_valuation_projection, publish_valuation_projection
...
def _independent_successor_prepared(successor_bundle: Mapping[str, Any], projection: Mapping[str, Any]) -> dict[str, Any]:
    from auto_alpha.platform.network_authority._internal.authorization.independent import _prepare
