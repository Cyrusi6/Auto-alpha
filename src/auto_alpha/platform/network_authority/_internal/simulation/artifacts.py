...
def publish_simulation_run(
    *,
    ...
    if valuation_projection_manifest is not None:
        from auto_alpha.platform.network_authority._internal.evidence.valuation import validate_valuation_projection
        ...
        from auto_alpha.platform.network_authority._internal.valuation.verifier import make_official_mark_rows
    ...
    if fee_schedule_manifest is not None:
        ...
        if candidate is not None:
            try:
                from auto_alpha.platform.network_authority._internal.evidence.fees import validate_fee_schedule_v2
