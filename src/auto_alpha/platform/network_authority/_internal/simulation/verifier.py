...
def recompute_run_truth(
    ...
    *,
    ...
    if valuation_projection_manifest is not None or projection_reference.is_file():
        from auto_alpha.platform.network_authority._internal.evidence.valuation import load_valuation_projection
        ...
        from auto_alpha.platform.network_authority._internal.valuation.verifier import build_mark_matrices
