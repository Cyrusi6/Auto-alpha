    ...
    *,
    ...
    try:
        for spec in specs:
            ...
            receipt = {
                "producer": "auto_alpha.platform.network_authority._internal.evidence.fees.acquire_official_fee_documents",
...
def _validate_retrieval_receipt(
    ...
    *,
    ...
    if receipt.get("producer") != "auto_alpha.platform.network_authority._internal.evidence.fees.acquire_official_fee_documents":
