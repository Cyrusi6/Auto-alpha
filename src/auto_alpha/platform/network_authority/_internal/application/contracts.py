...
SEMANTIC_SOURCE_PATHS = (
    ...
    "src/auto_alpha/data/ingestion/pipeline/ashare/config.py",
    "src/auto_alpha/data/ingestion/pipeline/ashare/providers/tushare_client.py",
    "src/auto_alpha/data/ingestion/pipeline/ashare/request_normalization.py",
    "src/auto_alpha/data/ingestion/pipeline/ashare/security.py",
    "src/auto_alpha/data/lake/store/task052_freeze.py",
    "src/auto_alpha/data/matrix/store/strict_engineering.py",
    "src/auto_alpha/research/features/factory/engineering_replay/orchestrator.py",
    "src/auto_alpha/validation/firewall/core/production_sentinel/sentinel.py",
