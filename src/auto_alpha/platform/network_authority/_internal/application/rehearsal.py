...
def _legacy_entrypoint_contract() -> dict[str, Any]:
    from auto_alpha.platform.network_authority._internal.validation.network_cli import _dispatch
    from auto_alpha.platform.network_authority._internal.validation.network_state import Task055GNetworkStateError
    import argparse
    try:
