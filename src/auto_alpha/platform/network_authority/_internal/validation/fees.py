...
def semantic_source_hashes() -> dict[str, str]:
    import auto_alpha.platform.network_authority._internal.simulation.policy as policy_module
    import auto_alpha.platform.network_authority._internal.simulation.simulator as simulator_module
    import auto_alpha.platform.network_authority._internal.simulation.verifier as verifier_module

    return {
        "auto_alpha.platform.network_authority._internal.simulation.policy": _module_source_hash(policy_module),
        "auto_alpha.platform.network_authority._internal.simulation.simulator": _module_source_hash(simulator_module),
        "auto_alpha.platform.network_authority._internal.simulation.verifier": _module_source_hash(verifier_module),
        "auto_alpha.platform.network_authority._internal.validation.fees": _source_hash(Path(__file__)),
    }
