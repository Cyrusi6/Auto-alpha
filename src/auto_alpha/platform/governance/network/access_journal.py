"""Audited, boundary-aware source reads."""
...
from auto_alpha.portfolio.simulator.evidence_contracts import MAX_DATE, READ_LEDGER_SCHEMA
        ...
        try:
            ...
            write_artifact_sidecar(
                ledger,
                {
                    ...
                    "schema_version": "1.0",
                    "producer": "auto_alpha.platform.governance.network.access_journal.AuditedReader",
