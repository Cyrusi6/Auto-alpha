...
def git_index_source_entries(repository: Path, *, treeish: str | None = None) -> list[dict[str, Any]]:
    ...
    required = {
        "src/auto_alpha/platform/governance/network/contracts.py",
        "src/auto_alpha/platform/governance/network/source_tree.py",
        "src/auto_alpha/platform/governance/network/broker.py",
        "src/auto_alpha/platform/governance/network/gateway.py",
        "src/auto_alpha/platform/governance/network/immutable.py",
        "src/auto_alpha/platform/governance/network/stage_machine.py",
        "src/auto_alpha/platform/governance/network/lease.py",
        "src/auto_alpha/platform/governance/network/release.py",
        "src/auto_alpha/platform/governance/network/application.py",
        "src/auto_alpha/platform/governance/network/application_cli.py",
        "src/auto_alpha/platform/governance/network/application_components.py",
        "src/auto_alpha/platform/governance/network/independent.py",
        "src/auto_alpha/platform/governance/network/rehearsal.py",
        "src/auto_alpha/platform/governance/network/network_cli.py",
        "src/auto_alpha/platform/governance/network/verifier.py",
