...
from auto_alpha.platform.artifacts.schema.report import build_validation_report, write_validation_report
from auto_alpha.platform.artifacts.schema.scanner import paths_from_artifact_catalog, scan_artifact_dirs
...
def _dashboard_import_smoke() -> tuple[str, str, dict]:
    importlib.import_module("auto_alpha.platform.observability.dashboard.app")
    return "passed", "auto_alpha.platform.observability.dashboard.app imported", {}
