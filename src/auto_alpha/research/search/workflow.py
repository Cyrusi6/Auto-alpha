"""Governed Alpha research workflow, reporting, and command entrypoint."""
...
from auto_alpha.platform.artifacts.schema.writer import write_json_artifact, write_jsonl_artifact
from auto_alpha.platform.compute.scheduler import ComputeDeviceType, ComputeJobKind, ComputeJobSpec, ComputeSchedulerConfig, LocalComputeScheduler
from auto_alpha.data.lake.store import validate_research_input
from auto_alpha.research.factors.store import FactorRecord, LocalFactorStore, make_factor_id
from auto_alpha.research.formulas.evaluator import FormulaBatchEvalConfig, FormulaBatchEvaluator, FormulaEvalRequest, merge_shard_outputs
from auto_alpha.research.formulas.data_loader import AShareDataLoader

from auto_alpha.research.features.factory import (
...
from auto_alpha.research.search.generation import select_shortlist
from auto_alpha.research.search.generation import write_diversity_outputs
from auto_alpha.research.search.generation import generate_alpha_candidates
from auto_alpha.research.search.evaluation import run_full_research
from auto_alpha.research.search.evaluation import assert_no_holdout_feedback_paths
from auto_alpha.research.search.models import AlphaCampaignConfig
from auto_alpha.research.search.models import AlphaCampaignManifest
from auto_alpha.research.search.models import AlphaFactoryReport
from auto_alpha.research.search.generation import score_novelty
...
from auto_alpha.research.search.generation import run_static_checks
...
class AlphaFactoryRunner:
    ...
    def _register_experiment_store(self, campaign, report_json: Path) -> None:
        ...
        if not (
            ...
            return
        from auto_alpha.research.search.experiments import ingest_alpha_factory_run
        from auto_alpha.research.search.experiments import compare_experiment_stores
    ...
    def _proxy_reference_matrices(self, loader) -> tuple[list[Any], str]:
        ...
        if not self.config.production_research:
            from auto_alpha.research.factors.engine import load_existing_factor_matrices
        ...
        for shard_id in range(shard_count):
            ...
            jobs.append(
                ComputeJobSpec(
                    ...
                    command=[sys.executable, "-m", "auto_alpha.research.formulas.evaluator"],
                    args=args,
                    cwd=str(Path.cwd()),
...
def _add_common_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument("--research-policy-id")
...
def main(argv: list[str] | None = None) -> int:
    ...
    config = AlphaCampaignConfig(
        ...
        research_policy_id=args.research_policy_id,
    )
