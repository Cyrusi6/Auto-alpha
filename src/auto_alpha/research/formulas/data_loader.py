"""JSONL data loader for A-share factor auto_alpha.research.search.studies."""
...
from auto_alpha.research.formulas.factors import AShareFeatureEngineer
...
class AShareDataLoader:
    ...
    def _load_from_matrix_cache(self) -> "AShareDataLoader":
        ...
        from auto_alpha.data.matrix.store import MatrixStoreReader
