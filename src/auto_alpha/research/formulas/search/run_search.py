"""CLI for search-style formula auto_alpha.research.discovery.studies."""
...
from auto_alpha.research.discovery.studies.composite import COMPOSITE_METHODS
from auto_alpha.research.discovery.orchestrator.merge import merge_formula_search_results
