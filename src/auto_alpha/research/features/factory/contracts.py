...
def feature_semantic_source_hash(extra_sources: Sequence[str | Path] = ()) -> str:
    ...
    from auto_alpha.research.formulas.runtime import data_loader, ops, vocab
    from auto_alpha.research.formulas.runtime import validity as vm_validity
    from auto_alpha.research.formulas.runtime import vm
