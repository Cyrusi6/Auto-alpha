...
def feature_semantic_source_hash(extra_sources: Sequence[str | Path] = ()) -> str:
    ...
    from auto_alpha.research.features import factory_builder as builder
    from auto_alpha.research.features import factory_catalog as catalog
    from auto_alpha.research.features import factory_extended_builder as extended_builder
    from auto_alpha.research.features import factory_validity as validity
    from auto_alpha.research.formulas import runtime_data_loader as data_loader
    from auto_alpha.research.formulas import runtime_ops as ops
    from auto_alpha.research.formulas import runtime_vocab as vocab
    from auto_alpha.research.formulas import runtime_validity as vm_validity
    from auto_alpha.research.formulas import runtime_vm as vm
