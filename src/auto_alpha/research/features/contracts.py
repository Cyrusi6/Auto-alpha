...
def feature_semantic_source_hash(extra_sources: Sequence[str | Path] = ()) -> str:
    ...
    from auto_alpha.research.features import builder
    from auto_alpha.research.features import catalog
    from auto_alpha.research.features import expanded as extended_builder
    from auto_alpha.research.features import validity
    from auto_alpha.research.formulas import data_loader
    from auto_alpha.research.formulas import operators as ops
    from auto_alpha.research.formulas import semantics as vocab
    from auto_alpha.research.formulas import semantics as vm_validity
    from auto_alpha.research.formulas import vm
