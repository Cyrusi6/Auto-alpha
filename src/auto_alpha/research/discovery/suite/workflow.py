...
from auto_alpha.data.pit.corporate_actions.run_actions import main as run_corporate_actions_main
from auto_alpha.data.ingestion.pipeline import run_pipeline
from auto_alpha.research.factors.store import LocalFactorStore, has_positive_oos_evidence
from auto_alpha.research.factors.lifecycle.run_lifecycle import main as run_lifecycle_main
from auto_alpha.research.formulas.batch.run_batch_eval import main as run_formula_batch_eval_main
from auto_alpha.research.formulas.corpus.run_corpus import main as run_formula_corpus_main
from auto_alpha.research.formulas.search import run_search
from auto_alpha.data.matrix.store.run_build_matrix import main as run_build_matrix_main
from auto_alpha.research.formulas.runtime.data_loader import AShareDataLoader
from auto_alpha.research.factors.registry import LocalModelRegistry, ModelKind, write_model_registry_report
from auto_alpha.research.neural.search.run_pretrain import main as run_pretrain_main
from auto_alpha.research.discovery.benchmark.run_benchmark import main as run_benchmark_main
from auto_alpha.execution.trading.strategy import runner as strategy_runner
from auto_alpha.data.pit.universe import run_universe
from auto_alpha.validation.lab.engine.run_validation import main as run_validation_main
from auto_alpha.validation.lab.campaigns.run_validation_store import main as run_validation_campaign_store_main
from auto_alpha.validation.certification.campaigns.run_certification_campaign import main as run_certification_campaign_main
from auto_alpha.validation.certification.factors.run_certify import main as run_certify_main
from auto_alpha.portfolio.construction.campaigns.run_portfolio_campaign import main as run_portfolio_campaign_main
...
from auto_alpha.validation.firewall.leakage.run_audit import main as run_leakage_audit_main
from auto_alpha.data.pit.engine.run_pit import main as run_pit_main
from auto_alpha.data.lake.store import LocalDataLakeRegistry, create_research_freeze, validate_research_input
...
from auto_alpha.data.lake.store.report import write_data_lake_report, write_dataset_version_manifest
from auto_alpha.data.lake.store.freeze import write_freeze_validation_report
from auto_alpha.research.discovery.orchestrator.workflows import run_workflow_smoke
from auto_alpha.research.discovery.factory.run_factory import main as run_alpha_factory_main
...
class ResearchSuiteRunner:
    ...
    def _stage_formula_corpus(self) -> tuple[dict[str, Any], dict[str, str]]:
        ...
        output_paths = {
            "formula_corpus": str(corpus_dir / "auto_alpha.research.formulas.corpus.jsonl"),
    ...
    def _stage_formula_batch_eval(self) -> tuple[dict[str, Any], dict[str, str]]:
        corpus_dir = self._formula_corpus_dir()
        if not (corpus_dir / "auto_alpha.research.formulas.corpus.jsonl").exists():
            self._stage_formula_corpus()
        ...
        argv = [
            ...
            str(batch_dir),
            "--corpus-path",
            str(corpus_dir / "auto_alpha.research.formulas.corpus.jsonl"),
            "--max-formulas",
    ...
    def _stage_compute_experiment(self) -> tuple[dict[str, Any], dict[str, str]]:
        ...
        corpus_path = self._formula_corpus_dir() / "auto_alpha.research.formulas.corpus.jsonl"
