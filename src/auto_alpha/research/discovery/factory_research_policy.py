"""Versioned two-stage Alpha Factory research policies; consolidated from auto_alpha.research.discovery.factory."""
...
from auto_alpha.research.discovery.evaluation import ObjectiveSpec
