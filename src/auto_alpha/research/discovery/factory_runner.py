...
from auto_alpha.research.formulas.batch import FormulaBatchEvalConfig, FormulaBatchEvaluator, FormulaEvalRequest, merge_shard_outputs
...
from auto_alpha.research.discovery.factory_diversity import select_shortlist
from auto_alpha.research.discovery.factory_diversity import write_diversity_outputs
from auto_alpha.research.discovery.factory_generators import generate_alpha_candidates
from auto_alpha.research.discovery.factory_full_research import run_full_research
from auto_alpha.research.discovery.factory_holdout_firewall import assert_no_holdout_feedback_paths
...
from auto_alpha.research.discovery.factory_novelty import score_novelty
...
from auto_alpha.research.discovery.factory_report import write_artifact_catalog
from auto_alpha.research.discovery.factory_report import write_campaign_report
from auto_alpha.research.discovery.factory_report import write_generation_stats
from auto_alpha.research.discovery.factory_report import write_jsonl
...
class AlphaFactoryRunner:
    ...
    def _register_experiment_store(self, campaign, report_json: Path) -> None:
        ...
        if not (
            ...
            return
        from auto_alpha.research.discovery.experiments import ingest_alpha_factory_run
        from auto_alpha.research.discovery.experiments_comparison import compare_experiment_stores
        ...
        for shard_id in range(shard_count):
            ...
            jobs.append(
                ComputeJobSpec(
                    ...
                    command=[sys.executable, "-m", "auto_alpha.research.formulas.batch_run_batch_eval"],
                    args=args,
                    cwd=str(Path.cwd()),
