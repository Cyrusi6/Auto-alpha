...
from auto_alpha.platform.compute.scheduler.models import ComputeDeviceType, ComputeJobKind, ComputeJobSpec
...
def create_experiment_plan(config: dict[str, Any]) -> ExperimentPlan:
    ...
    for shard in shards:
        ...
        command = [
            sys.executable,
            "-m",
            "auto_alpha.research.formulas.batch.run_batch_eval",
            "--data-dir",
            data_dir,
            "--factor-store-dir",
