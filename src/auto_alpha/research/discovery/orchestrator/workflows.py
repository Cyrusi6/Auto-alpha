...
from auto_alpha.platform.compute.scheduler import ComputeSchedulerConfig, LocalComputeJobStore, LocalComputeScheduler
...
def _job_from_payload(row: dict):
    from auto_alpha.platform.compute.scheduler.models import ComputeJobSpec
