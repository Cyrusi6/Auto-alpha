"""CLI for batch A-share factor auto_alpha.research.discovery.studies."""
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run batch A-share factor auto_alpha.research.discovery.studies.")
