...
Git-safe evidence is `evidence/task_055_k/task055kr_scrubbed_evidence.json`. Verify it with `python task_055_k/verifier.py evidence/task_055_k/task055kr_scrubbed_evidence.json --repository-root .`; the verifier is standard-library only and does not authorize a request.
