...
DATASET_DEFINITIONS: dict[str, AShareDatasetDefinition] = {
    ...
    "suspensions": AShareDatasetDefinition(
        ...
        primary_key=("ts_code", "trade_date", "suspend_type", "suspend_timing"),
        date_field="trade_date",
        availability_date_field="trade_date",
        effective_date_field="trade_date",
        description="Canonical daily suspension/resumption events (S/R).",
        chunk_strategy="trade_day",
        date_param_mode="single",
        single_date_param="trade_date",
        weak_pit=True,
    ),
    "st_status_daily": AShareDatasetDefinition(
        dataset="st_status_daily",
        api_name="stock_st",
        ...
        availability_date_field="trade_date",
        effective_date_field="trade_date",
        description="Daily ST/*ST/delisting-risk status from stock_st.",
        chunk_strategy="trade_day",
        date_param_mode="single",
        single_date_param="trade_date",
        weak_pit=True,
