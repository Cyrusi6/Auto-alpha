...
| CNINFO document closure | **v4 已暂停、未发布；v5 已获 2026-08-27 恢复授权并通过 plan-only**：v4 activity `12198c1c...` 保留 3,659 positive 后停在 `59086622`。v5 contract/activity 预计算为 `7f1a44dc.../c7425780...`；2011 为 23,485 demand、23,440 份文档、0 reuse、0 blocker、41,919,184,896-byte 分片预算 | v5 只新增严格有界的 20-byte legacy binary trailer，并要求真实 xref；完整重跑 2011 后串行 2012–2019，不能复用 v4 authorization/partial。全链仍锁定 342,516 份、512 GiB 和最多 2 次重试；任一新异常停止。九年完成后仍须离线证明唯一 disposition |
