...
| Baostock `hs300-snapshots` v3 | **已批准、待启动**：完整 1,946 日期；contract `632e961c...`、预计 activity `0ad187d7...`；最多 13,622 requests / 27,244 exchanges | 独立 `hs300_snapshots_v3/`；不复用 v1/v2；初始 + 6 retries，冷却 5/15/30/60/120/300 秒；只授权数据补采，发布后仍是 PIT reconciliation 而非 Admission |
